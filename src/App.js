...
function createNoteElementImportant(id, content) {
  ...
  element.value = content;
  element.placeholder = "Título de la nota. Agrega una breve descripción en este post it";
...
function addNote() {
  ...
  const noteObject = {
    "id" : 0, "content": "Agregue un título. Agregue una breve descripción en la nota."
  };
...
function addNoteImportant() {
  ...
  const noteObject = {
    "id" : 0, "content": "Agregue un título. Agregue una descripción en la nota."
  };
